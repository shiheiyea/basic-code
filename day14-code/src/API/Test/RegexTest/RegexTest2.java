...
public class RegexTest2 {
    public static void main(String[] args) {
        ...
        */
        ...
        //用户名要求           要求:大小写字母，数字，下划线一共4-16位
        String regex1 = "\\w{4,16}";
        System.out.println("heiye".matches(regex1));

        String regex2 = "[1-9]\\d{16}(x|X|\\d)";
        String regex3 = "[1-9]\\d{16}[x|X|\\d]";
        String regex5 = "[1-9]\\d{16}[\\d(?i)x]";
        System.out.println("440183200403137517".matches(regex3));
        ...
        //前面6位: 省份，市区，派出所等  信息第一位不能是0，后面5位是任意数字       [1-9]\\d{5}
        //年的前半段: 18 19 20                                                  (18|19|20)
        //年的后半段:任意 数字出现两次                                            \\d{2}
        //月份:   01~09   10 11 12                                              ([1-9]|1[0-2])
        //日期:   01~09   10~19   20~29 30 31                                   (θ[1-9]|[12]\\d|3[01])
        //后面四位: 任意数字出现3次最后一位可以是数字也可以是大写x或者小写x          \\d{3}[\\dXx]
        ...
        System.out.println("440183200403137517".matches(regex6));
